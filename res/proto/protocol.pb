...
userDemand (R
userDemand"
nowTableTime (RnowTableTime"é
NoticeMainPlayer
	userExtra (R	userExtra
baseCard (RbaseCard
	iRoomTime (R	iRoomTime"
nowTableTime (RnowTableTime"ä
Item
user_id (	RuserId
user_pos (RuserPos
	cur_score (RcurScore
score (Rscore
	card_list (RcardList"Ì
NoticeDDZGameOver"
...
four_card_list (2.msg.user.FourCardItemRfourCardList"ñ
NoticePlayCard
user_id (RuserId
card (Rcard
user_pos (RuserPos<
